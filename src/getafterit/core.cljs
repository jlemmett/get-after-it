(ns getafterit.core
  ...
  (:require [goog.events :as events]
            ...
            [getafterit.events] ;; These two are only required to make the compiler
            [getafterit.subs]   ;; load them (see docs/Basic-App-Structure.md)
            [getafterit.views]
...
(defn ^:export main
  ...
  ;; The view function `getafterit.views/todo-app` is the
  ;; root view for the entire UI.
  (reagent/render [getafterit.views/getafterit-app]
